...
class TestPluginDialog(QDialog):
    def __init__(self):
        ...
        self.edit_lbl = QLabel('Enter attribute value:', self)
        self.edit = QLineEdit(self)
        self.btn_ok_1 = QPushButton('Select Features', self)
        self.layout_1.addWidget(self.v_cb_lbl, 0, 0)  # item, row, column
        self.layout_1.addWidget(self.vector_cb, 0, 1)
        self.layout_1.addWidget(self.f_cb_lbl, 1, 0)
        self.layout_1.addWidget(self.fld_cb, 1, 1)
        self.layout_1.addWidget(self.edit_lbl, 2, 0)
        self.layout_1.addWidget(self.edit, 2, 1)
        self.layout_1.addWidget(self.btn_ok_1, 3, 1)
